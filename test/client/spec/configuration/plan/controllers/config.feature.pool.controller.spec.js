...
describe('FeaturePoolCtrl', () => {
    ...
    beforeEach(inject(($rootScope, $q, $timeout, _App_, $controller) => {
        scope = $rootScope.$new();
    ...
    it('addApp: should add a new App to the appPool and make that selected for edit', () => {
        controller.addApp();
    ...
    it('deleteApp: should delete the selected App and reinitialize the selected', () => {
        controller.deleteApp();
